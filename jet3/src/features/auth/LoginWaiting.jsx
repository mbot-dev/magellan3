...
import { CANCEL_TEXT } from "../../aux/FormUtil";

const LoginWaiting = ({ loginName, onCancel, onResend }) => {
            ...
            <Inner>
                ...
                <Contents>
                    <div className="z3-flex-column" style={{'--gap': '8px'}}>
                        <span>{loginName}に電子メールを送信しました。受信したメールを開きログインしてください。</span>
