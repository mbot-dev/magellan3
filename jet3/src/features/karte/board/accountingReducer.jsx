        ...
        switch (type) {
            ...
            case 'addBundle': {
                ...
                if (index !== -1) {
                    ...
                    const rowG = draft.render === 'mosaic' ? entity : group; // `${group}:${entity}:${name}` : group;
                    const date = draft.karteList[draft.selectedIndex].createdAt;
                    const idx = draft.pivot[rowG][date].findIndex(x => x === payload.id);
            ...
            case 'undo':
                return produce(
                    ...
                    newDraft => {
                        newDraft.canUndo = Object.prototype.hasOwnProperty.call(changes, currentVersion);
            ...
            case 'redo':
                return produce(
                    ...
                    newDraft => {
                        ...
                        newDraft.canRedo = Object.prototype.hasOwnProperty.call(changes, currentVersion + 1);
                    }
                );
            case 'testPop':
