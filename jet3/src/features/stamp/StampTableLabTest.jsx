...
const StampTableLabTest = ({ origin = "tool", maxHeight }) => {
...
const LEGEND = "診療行為・医薬品・特定器材をセットにしてください";

const EnhancedStampTableLabTest = withDisplayBlock(StampTableLabTest);
export default EnhancedStampTableLabTest;
